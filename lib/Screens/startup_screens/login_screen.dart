        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
                  ...
                  builder: (BuildContext loginButtonContext) {
                    return RaisedButton(
                      ...
                      onPressed: () async {
                        ...
                        try {
                          final firebaseUser = await FirebaseAuth.instance.signInWithEmailAndPassword(email: _email, password: _password);
                                  ...
                                  Row(
                                    children: <Widget>[
                                      Padding(
                                        ...
                                        child: Text("Would you like another verification email to be sent?"),
                                      )
                                    ],
                                  ),
                                  Row(
              ...
              Text("Don\'t have an account?", style: TextStyle(fontSize: 10.0),),
              SizedBox(height: 5.0),
              ButtonTheme(
                minWidth: 10.0,
                height: 30.0,
                  child: RaisedButton(
                    child: Text("Sign Up Here!", style: TextStyle(fontSize: 10.0),),
                    color: Colors.blue,
                    textColor: Colors.white,
                    elevation: 7.0,
                    onPressed: () {
